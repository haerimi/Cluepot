...
const variantStyles: Record<Variant, string> = {
  primary:
    "bg-[#7C5CFC] text-white hover:bg-[#6B4AEF] active:bg-[#5A38E3] shadow-[0_1px_3px_rgba(124,92,252,0.3)] hover:shadow-[0_2px_8px_rgba(124,92,252,0.35)] disabled:bg-[#C4C1BC] disabled:shadow-none",
  secondary:
    ...
    return (
      <button
        ...
        className={[
          ...
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7C5CFC] focus-visible:ring-offset-2 focus-visible:ring-offset-[#F4F2EE]",
