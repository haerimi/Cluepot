...
const variantStyles: Record<Variant, string> = {
  primary:
    "bg-[#FF5C00] text-white hover:bg-[#E65200] active:bg-[#CC4900] shadow-[0_1px_3px_rgba(255,92,0,0.3)] hover:shadow-[0_2px_8px_rgba(255,92,0,0.35)] disabled:bg-[#C4C1BC] disabled:shadow-none",
  secondary:
    ...
    return (
      <button
        ...
        className={[
          ...
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF5C00] focus-visible:ring-offset-2 focus-visible:ring-offset-[#F4F2EE]",
