  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="flex-1 bg-transparent border-none outline-none text-[16px] text-[#f7f8f8] placeholder:text-[#3e3e44] min-w-0 py-[14px]"
      />
    </div>
  );
}
      ...
      >
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 sm:gap-4" aria-label="인증 네비게이션">
            ...
            <Link
              href="/signup"
              className="h-9 px-4 text-[13px] font-semibold rounded-lg border border-[#34343a] text-[#d0d6e0] hover:text-white hover:border-[#454652] hover:bg-[#1a1a1e] flex items-center justify-center transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#5e6ad2]"
            >
              회원가입
            </Link>
          </nav>
